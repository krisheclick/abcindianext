...
interface LegalStatusDescriptionProps {
  page_name: string;
...
export default function LegalStatusDescription({
  page_name,
  page_short_description,
  page_content,
  page_feature_image,
}: LegalStatusDescriptionProps) {
  return (
    <section className="legal-status-description">
